...
void TCIntegrator::DonorCellX1(int const k, int const j,
...
void TCIntegrator::DonorCellX2(int const k, int const j,
                               int const il, int const iu,
                               AthenaArray<Real> const &u_tc,
                               AthenaArray<Real> const &rho,
                               AthenaArray<Real> const &tgas,
...
void TCIntegrator::DonorCellX3(int const k, int const j,
                               int const il, int const iu,
                               AthenaArray<Real> const &u_tc,
                               AthenaArray<Real> const &rho,
                               AthenaArray<Real> const &tgas,
...
void TCIntegrator::PieceWiseLinear(int const k, int const j,
                                   int const il, int const iu,
...
void TCIntegrator::GetOneVariableX1(int const k, int const j,
                                    int const il, int const iu,
                                    AthenaArray<Real> const &q,
                                    AthenaArray<Real> &ql,
                                    AthenaArray<Real> &qr)
{
  auto pco = pmy_tc->pmy_hydro->pmy_block->pcoord;
...
void TCIntegrator::GetOneVariableX2(int const k, int const j,
                                    int const il, int const iu,
                                    AthenaArray<Real> const &q,
                                    AthenaArray<Real> &ql,
                                    AthenaArray<Real> &qr)
...
void TCIntegrator::GetOneVariableX3(int const k, int const j,
                                    int const il, int const iu,
                                    AthenaArray<Real> const &q,
                                    AthenaArray<Real> &ql,
                                    AthenaArray<Real> &qr)
